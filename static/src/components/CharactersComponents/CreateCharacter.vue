      ...
      fetch(API_URL+'/character',
            {
                ...
                credentials:'include',
                body: JSON.stringify({name: JSON.parse(JSON.stringify(this.newCharacterData.name)), class: JSON.parse(JSON.stringify(this.newCharacterData.classe)), stats: this.newCharacterData.stats, image: this.newCharacterData.image}),
            })
            .then((resp) =>
            {
                resp.json();
